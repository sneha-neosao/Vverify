...
//
//     final educationDataDetailsModel = educationDataDetailsModelFromJson(jsonString);

import 'dart:convert';

EducationDataDetailsModel educationDataDetailsModelFromJson(String str) => EducationDataDetailsModel.fromJson(json.decode(str));

String educationDataDetailsModelToJson(EducationDataDetailsModel data) => json.encode(data.toJson());

class EducationDataDetailsModel {
  int? status;
  String? message;
  Data? data;
  ...
  factory EducationDataDetailsModel.fromJson(Map<String, dynamic> json) => EducationDataDetailsModel(
    status: json["status"],
