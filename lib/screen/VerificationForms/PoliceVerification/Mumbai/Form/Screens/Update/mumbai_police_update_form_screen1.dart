...
import 'mumbai_police_update_form_screen2.dart';

class MumbaiPoliceUpdateFormScreen1 extends StatefulWidget {
  String uid;

  MumbaiPoliceUpdateFormScreen1({super.key, required this.uid});

  @override
  State<MumbaiPoliceUpdateFormScreen1> createState() =>
      _MumbaiPoliceUpdateFormScreen1State();
}

class _MumbaiPoliceUpdateFormScreen1State
    extends State<MumbaiPoliceUpdateFormScreen1> {
