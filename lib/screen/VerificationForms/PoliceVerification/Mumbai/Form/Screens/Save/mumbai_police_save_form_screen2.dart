...
import 'mumbai_police_save_form_screen3.dart';
import '../../TextControllers/mumbai_police_text_controller.dart';

class MumbaiPoliceSaveFormScreen2 extends StatefulWidget {
  const MumbaiPoliceSaveFormScreen2({super.key});

  @override
  State<MumbaiPoliceSaveFormScreen2> createState() =>
      _MumbaiPoliceSaveFormScreen2State();
}

class _MumbaiPoliceSaveFormScreen2State
    extends State<MumbaiPoliceSaveFormScreen2> {
                            ...
                            onTap: () {
                              ...
                              if (_formKey.currentState?.validate() ?? false) {
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            const MumbaiPoliceSaveFormScreen3()));
                              } else {
