...
import '../../../../Common/PoliceStationId/police_station_id_bloc/police_station_id_cubit.dart';
import '../../../../Common/PoliceStationId/police_station_id_bloc/police_station_id_state.dart';
import '../../../../Common/PoliceStationId/Models/police_station_city_id_model.dart';
import '../../../../Common/PoliceStationId/Models/police_station_id_model.dart';
import 'mumbai_police_save_form_screen2.dart';
...
class MumbaiPoliceSaveFormScreen1 extends StatefulWidget {
  const MumbaiPoliceSaveFormScreen1({super.key});

  @override
  State<MumbaiPoliceSaveFormScreen1> createState() =>
      _MumbaiPoliceSaveFormScreen1State();
}

class _MumbaiPoliceSaveFormScreen1State
    extends State<MumbaiPoliceSaveFormScreen1> {
                            ...
                            onTap: () {
                              ...
                              if (_formKey.currentState?.validate() ?? false) {
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                        const MumbaiPoliceSaveFormScreen2()
                                    )
                                );
                              } else {
                                if (context.read<PropertyOwnersProfileImage>().state.path.isEmpty) {
