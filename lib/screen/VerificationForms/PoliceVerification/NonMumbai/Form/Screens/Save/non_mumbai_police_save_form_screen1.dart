...
import 'non_mumbai_police_save_form_screen2.dart';

class NonMumbaiPoliceSaveFormScreen1 extends StatefulWidget {
  const NonMumbaiPoliceSaveFormScreen1({super.key});

  @override
  State<NonMumbaiPoliceSaveFormScreen1> createState() =>
      _NonMumbaiPoliceSaveFormScreen1State();
}

class _NonMumbaiPoliceSaveFormScreen1State
    extends State<NonMumbaiPoliceSaveFormScreen1> {
                                ...
                                if (_formKey.currentState?.validate() ?? false) {
                                  if (context
                                    ...
                                    Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                            builder: (context) =>
                                                const NonMumbaiPoliceSaveFormScreen2()));
                                  }
                                } else {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                      const SnackBar(
