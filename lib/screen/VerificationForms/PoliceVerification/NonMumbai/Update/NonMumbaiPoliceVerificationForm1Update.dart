...
import 'NonMumbaiPoliceVerificationForm2Update.dart';

class NonMumbaiPoliceVerificationForm1Update extends StatefulWidget {
  String uid;

  NonMumbaiPoliceVerificationForm1Update({super.key, required this.uid});

  @override
  State<NonMumbaiPoliceVerificationForm1Update> createState() =>
      _NonMumbaiPoliceVerificationForm1UpdateState();
}

class _NonMumbaiPoliceVerificationForm1UpdateState
    extends State<NonMumbaiPoliceVerificationForm1Update> {
                                ...
                                onTap: () {
                                  ...
                                  if (_formKey.currentState?.validate() ??
                                    ...
                                    Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                            builder: (context) =>
                                                const NonMumbaiPoliceVerificationForm2Update()));
                                  } else {
