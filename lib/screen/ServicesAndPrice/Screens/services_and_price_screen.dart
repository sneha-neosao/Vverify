                                                                ...
                                                                children: [
                                                                  Container(
                                                                    ...
                                                                    decoration: BoxDecoration(
                                                                      ...
                                                                      borderRadius: BorderRadius.circular(6), // optional for rounded corners
                                                                    ),
                                                                    child: const Center(
                                                                      child: const Icon(Icons.local_activity_outlined,color: Colors.white,size: 22,),
                                                                    )
                                                                  ),
                                                                  const SizedBox(width: 12,),
                                                                  const Text("Have a coupon code ?", style: TextStyle(color: Colors.orange,fontSize: 14),),
                                                                  const Spacer(),
                                                                  InkWell(
                                                                    onTap: (){
                                                                      setState(() {
                                                                    ...
                                                                    child: const Row(
                                                                      children: [
                                                                        const Padding(
                                                                          ...
                                                                          child: const Text("Apply", style: TextStyle(color: Colors.orange,fontSize: 16),),
                                                                        ),
                                                                        const Icon(Icons.arrow_circle_right_outlined,color: Colors.orange,size: 22,)
                                                                      ],
                                                                    ),
                                                                  )
                                                                ],
