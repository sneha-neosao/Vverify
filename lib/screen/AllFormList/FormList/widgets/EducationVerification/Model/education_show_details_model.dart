...
EducationDataDetailsModel educationDataDetailsModelFromJson(String str) =>
    EducationDataDetailsModel.fromJson(json.decode(str));

String educationDataDetailsModelToJson(EducationDataDetailsModel data) =>
...
class EducationDataDetailsModel {
  ...
  factory EducationDataDetailsModel.fromJson(Map<String, dynamic> json) =>
      EducationDataDetailsModel(
        status: json["status"],
